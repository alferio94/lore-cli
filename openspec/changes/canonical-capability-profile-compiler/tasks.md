...
- W4.2 split authorized: 4.2A (248/250) is complete and bound to commit `87c4fac789f6f99ceee9116b0b5cb1f284311ac0` / current verify report `87c30178-eb59-47ff-9703-f571567d608e` (superseding and preserving prior `f673d9c1-9141-4bdc-8971-1fd2a065327c`); 4.2B (150/150) remains pending child task, aggregate 398/400 is non-transferable, 4.2B has zero spare lines, and any drift requires fail-stop/new preflight; original/gofmt/SIGPIPE/cap-failure lineages are preserved.
...
- [ ] 4.2 Split pending W4 task into child tasks 4.2A and 4.2B; keep parent unchecked until both children independently validate/verify; aggregate 398/400 is non-transferable, and 4.2B has zero spare lines.
  - [x] 4.2A Add `internal/install/{workflow_contract,result,event,error,legacy_adapter}.go` plus `workflow_contract_test.go` for Request/Prepared/Result/Event/Error, Observer, defensive-copy, one-shot, and error coverage; cap250; authority from candidate `454b65f5-c0a7-4c0c-aa1c-6567f8312e12` and report `05991af6-00f9-48f3-a276-b99fee18a821`; completed by independent PASS on commit `87c4fac789f6f99ceee9116b0b5cb1f284311ac0` and current verify report `87c30178-eb59-47ff-9703-f571567d608e`, which supersedes and preserves prior report `f673d9c1-9141-4bdc-8971-1fd2a065327c`.
  - [ ] 4.2B Add `internal/install/route_policy.go` plus `route_policy_test.go` for per-target Gate/RoutePolicy demotion, E→D→A gating, explicit legacy/no-fallback behavior, and table-driven route coverage; cap150 with zero headroom; depends on accepted A commit/tree/manifest `87c4fac789f6f99ceee9116b0b5cb1f284311ac0` / `84b342e4f471e453c995c6c72e5cc46d543b8278` / `830a4801a4008ae3f8383a5a535808b4e407e6e380a1e40f45e0cd7b01816789`, rebased candidate `21003b51-ed5e-4919-836a-8beb84a9e52f`, and exact original-candidate lineage `3f242308-6f80-4553-91ce-2724655c7145`; any B byte or line drift requires fail-stop/task correction.
